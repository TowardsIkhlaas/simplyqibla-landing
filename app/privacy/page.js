export default function Privacy() {
    return (
        <body>
            ...
            <p>This privacy policy applies to the SimplyQibla app (hereby referred to as &quot;Application&quot;) for mobile devices that was created by Towards Ikhlaas (hereby referred to as &quot;Service Provider&quot;) as an Open Source service. This service is intended for use &quot;AS IS&quot;.</p>
            <br></br>
            ...
            <br></br><strong>Children</strong>
            <p>The Application is not used to knowingly solicit data from or market to children under the age of 13.</p>
            <br></br>
            <p>The Service Provider does not knowingly collect personally identifiable information from children. The Service Provider encourages all children to never submit any personally identifiable information through the Application and/or Services. The Service Provider encourage parents and legal guardians to monitor their children&apos;s Internet usage and to help enforce this Policy by instructing their children never to provide personally identifiable information through the Application and/or Services without their permission. If you have reason to believe that a child has provided personally identifiable information to the Service Provider through the Application and/or Services, please contact the Service Provider (towardsikhlaas+privacy@gmail.com) so that they will be able to take the necessary actions. You must also be at least 16 years of age to consent to the processing of your personally identifiable information in your country (in some countries we may allow your parent or guardian to do so on your behalf).</p>
            ...
            <br></br>
            <p>This privacy policy is effective as of 2024-06-27</p>
            <br></br><strong>Your Consent</strong>
            ...
            <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at towardsikhlaas+privacy@gmail.com.</p>
            <hr></hr>
